...
import "./OneInchV4TokenSwapper.sol";

/**
 * @title The SimpleOneInchV4TokenSwapper token swapper.
 * @notice The SimpleOneInchV4TokenSwapper contract allows to leverage
 * the 1Inch dex aggregator to perform a swap and return swapped tokens
 * to the sender.
 * @author Alessandro Sanino (@saniales)
 */
contract SimpleOneInchV4TokenSwapper is OneInchV4TokenSwapper, Pausable, Ownable {
    using SafeERC20 for IERC20;

    /**
     * @notice Creates a new instance of the SimpleOneInchV4TokenSwapper contract.
    ...
    constructor(address _aggregationRouterOneInch, IERC20 _destinationToken)
        OneInchV4TokenSwapper(_aggregationRouterOneInch, _destinationToken)
        Pausable()
        Ownable()
    {}

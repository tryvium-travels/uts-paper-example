...
/**
 * @title The OneInchV4RouterMock: a OneInchV4 router mock contract.
 * @notice The OneInchV4RouterMock contract allows to mock
 * the behaviour of the 1Inch v4 router.
 * Swaps only one pair, specified in contract deploy, with
 * a specified ratio.
 * @author Alessandro Sanino (@saniales)
 */
contract OneInchV4RouterMock {

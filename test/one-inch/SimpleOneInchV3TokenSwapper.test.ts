...
describe("dex-implementations/one-inch/SimpleOneInchV3TokenSwapper tests", () => {
    ...
    let one_inch_router_mock: OneInchV3RouterMock;
    let mocked_dex_swapper: SimpleOneInchV3TokenSwapper;
    let real_dex_swapper: SimpleOneInchV3TokenSwapper;
    ...
    before(async () => {
        ...
        const dex_swapper_factory = await ethers.getContractFactory("SimpleOneInchV3TokenSwapper");
        ...
        ) as SimpleOneInchV3TokenSwapper;
    });

    beforeEach(async () => {
        const one_inch_router_mock_factory = await ethers.getContractFactory("OneInchV3RouterMock");
        const dex_swapper_factory = await ethers.getContractFactory("SimpleOneInchV3TokenSwapper");
    ...
    async function test_swap(
        ...
        dex_swapper: SimpleOneInchV3TokenSwapper,
        token_base: ERC20,
        token_quote: ERC20,
